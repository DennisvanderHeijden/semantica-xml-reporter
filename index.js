 ...
 * @returns {*}
 */
DmanReporter = function (newman, reporterOptions) {
    newman.on('beforeDone', function () {
        ...
        _.forEach(cache, function (executions, itemId) {
            ...
            suite.att('classname', _.get(suite, 'attributes.name.value', 'JUnitXmlReporter.constructor'));
